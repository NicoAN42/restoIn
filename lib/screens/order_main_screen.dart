...
class _OrderMainScreenState extends State<OrderMainScreen> {
  ...
  void updateOrderType() async {
    orderTypeResult = await Navigator.push(
        context,
        MaterialPageRoute<OrderTypeResult>(
            builder: (context) => ChangeOrderTypeScreen()));
                      ...
                      children: <Widget>[
                        Row(
                          children: <Widget>[
                            ...
                            SizedBox(width: 10),
                            Text(
                                orderTypeResult.orderType == null
                                    ? "Take Away"
                      ...
                      child: Row(
                          ...
                          children: <Widget>[
                            Text("Date",
                                style: Styles.customStyle("mediumblack")),
                            Text(
                                orderTypeResult.date == null
                                    ? "Null"
                                    : orderTypeResult.date,
                                style: Styles.customStyle("mediumblack")),
                          ]),
                    ),
                    Container(
                      ...
                      child: Row(
                          ...
                          children: <Widget>[
                            Text("Time",
                                style: Styles.customStyle("mediumblack")),
                            Text(
                                orderTypeResult.time == null
                                    ? "Null"
                                    : orderTypeResult.time,
                                style: Styles.customStyle("mediumblack")),
                          ]),
                    ),
                    Visibility(
                      visible:
                          orderType == "Dine In" || orderType == "Book Place",
                      child: Container(
                        width: screenWidth * 0.9,
                        child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: <Widget>[
                              Text("Guest",
                                  style: Styles.customStyle("mediumblack")),
                              Text(
                                  orderTypeResult.guest == null
                                      ? 0
                                      : orderTypeResult.guest.toString(),
                                  style: Styles.customStyle("mediumblack")),
                            ]),
                      ),
                    ),
