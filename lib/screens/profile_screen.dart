              ...
              Row(
                children: <Widget>[
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Text("RR Marcel Osmond A", style: Styles.customStyle("midboldblack")),
                      GestureDetector(
                        onTap: () {
                        ...
                        child: Container(
                          child: Row(
                            children: <Widget>[
                              Text("Edit Profile", style: Styles.customStyle("midblack")),
                              SizedBox(width: 20),
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Text("Membership", style: Styles.customStyle("midblack")),
                            Icon(FontAwesomeIcons.angleRight, size: 16)
                          ],
                        ),
                      ),
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: <Widget>[
                            Text("My Order", style: Styles.customStyle("midblack")),
                            Icon(FontAwesomeIcons.angleRight, size: 16)
                          ],
                        ),
                      ),
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: <Widget>[
                            Text("My Voucher", style: Styles.customStyle("midblack")),
                            Icon(FontAwesomeIcons.angleRight, size: 16)
                          ],
                        ),
                      ),
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: <Widget>[
                            Text("Notification", style: Styles.customStyle("midblack")),
                            Switch(
                              value: isSwitched, 
                              onChanged: (value) {
                                setState(() {
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: <Widget>[
                            Text("Language", style: Styles.customStyle("midblack")),
                            Row(
                              children: <Widget>[
                                Text(language, style: Styles.customStyle("midgray")),
                                SizedBox(width: 10),
                                isLanguageDisplay ? Icon(FontAwesomeIcons.angleUp, size: 16) : Icon(FontAwesomeIcons.angleDown, size: 16)
                              ],
                            ),
                          ],
                        ),
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              Text("English", style: Styles.customStyle("midgray")),
                              SizedBox(width: 26),
                            ],
                          ),
                        ),
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.end,
                            children: <Widget>[
                              Text("Indonesian", style: Styles.customStyle("midgray")),
                              SizedBox(width: 26),
                            ],
                          ),
                        ),
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: <Widget>[
                            Text("Privacy Policy", style: Styles.customStyle("midblack")),
                            Icon(FontAwesomeIcons.angleRight, size: 16)
                          ],
                        ),
                      ),
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: <Widget>[
                            Text("Terms of Service", style: Styles.customStyle("midblack")),
                            Icon(FontAwesomeIcons.angleRight, size: 16)
                          ],
                        ),
                      ),
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: <Widget>[
                            Text("Rate Us", style: Styles.customStyle("midblack")),
                            Icon(FontAwesomeIcons.angleRight, size: 16)
                          ],
                        ),
                      ),
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: <Widget>[
                            Text("Logout", style: Styles.customStyle("midboldblack")),
                            Icon(FontAwesomeIcons.angleRight, size: 16)
                          ],
                        ),
                      ),
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: <Widget>[
                  Text("Logout", style: Styles.customStyle("largerboldblack")),
                ],
              ),
            )
          ),
              ...
              child: Row(
                ...
                children: <Widget>[
                  FlatButton(
                    ...
                    child: Text("Yes", style: Styles.customStyle("mediumwhite")),
                    color: Styles.gray,
