          ...
          child: Column(
            ...
            children: <Widget>[
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    GestureDetector(
                      ...
                      child: Text("Save", style: Styles.customStyle("mediumorange"))
                    )
                  ],
                ),
              ),
              ...
              Row(
                children: <Widget>[
                  Container(
                    ...
                    child: Center(child: Text("Edit", style: Styles.customStyle("mediumwhite"))),
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            Image.asset("assets/icon/centang.png", width: 16, height: 16)
                          ],
                        ),
                      ),
                      GestureDetector(
                        ...
                        child: Container(
                          child: Row(
                            children: <Widget>[
                              Text("Change Name", style: Styles.customStyle("midgray")),
                            ],
                          )
                        ),
                      )
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: <Widget>[
                          Text("contoh@gmail.com", style: Styles.customStyle("midblack")),
                          Image.asset("assets/icon/centang.png", width: 16, height: 16)
                        ],
                      ),
                    ),
                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: <Widget>[
                          Text("+6285627477182", style: Styles.customStyle("midblack")),
                          Image.asset("assets/icon/centang.png", width: 16, height: 16)
                        ],
                      ),
                    ),
              ...
              Container(
                ...
                child: Column(
                  children: <Widget>[
                    Text("Link Your Account", style: Styles.customStyle("mediumgray")),
                    SizedBox(height: 10),
                    Container(
                      width: screenWidth * 0.9,
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Image.asset("assets/icon/facebook_logo.png", width: 25, height: 25),
                          Image.asset("assets/icon/google_logo.png", width: 25, height: 25),
                          Container(
                            width: screenWidth * 0.3,
                            height: 2,
                            color: Styles.white
