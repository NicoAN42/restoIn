...
class NotificationScreen extends StatefulWidget {
  ...
  const NotificationScreen({Key key, this.c, this.otr}) : super(key: key);
...
class _NotificationScreenState extends State<NotificationScreen> {
  ...
  void showDeletePopUp() async {
    bool result = await showDialog(
        context: context, builder: (context) => DeleteAllPopUp());
                          ...
                          background: Container(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                SizedBox(width: 20),
                                Text("Delete",
                                    style: Styles.customStyle("midboldwhite"))
                              ],
                            ),
                          ),
                            ...
                            Scaffold.of(context).showSnackBar(SnackBar(
                                content: Row(
                                  ...
                                  Text("Notification Deleted",
                                      style:
                                          Styles.customStyle("midboldwhite")),
                                  GestureDetector(
                                      onTap: () {
                          ...
                          child: GestureDetector(
                              ...
                              child: Column(children: <Widget>[
                                ListTile(
                                  ...
                                  title: Text(
                                      "You got message from Haragakure !",
                                      style: Styles.customStyle("midblack")),
                                  subtitle: Text(
                                      "Come to our resto and get 10% discount",
